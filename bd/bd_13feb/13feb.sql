...
INSERT INTO `centrocostos` VALUES (1,'GASTOS');
...
CREATE TABLE `inflacion` (
  ...
  `inflamensual` decimal(3,2) NOT NULL,
...
CREATE TABLE `maeconta` (
  ...
  `porete` decimal(3,2) DEFAULT NULL,
...
INSERT INTO `maeconta` VALUES ('1','M','ACTIVO','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('11','M','DISPONIBLE','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1105','M','CAJA','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('110505','A','CAJA GENERAL','','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('11050501','A','CAJA GENERAL SEDE NORTE','\0','\0','',1,'110505','110505',NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1110','M','BANCOS','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('111005','A','MONEDA NACIONAL','','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1115','M','REMESAS EN TRANSITO','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('12','M','INVERSIONES','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('2','M','PASIVO','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('3','M','PATRIMONIO','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('4','M','PATRIMONIO','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('5','M','GASTOS','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('6','M','COSTOS DE VENTA','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('7','M','COSTOS DE PRODUCION O DE OPERACION','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('8','M','CUENTAS DE ORDEN DEUDORAS','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('9','M','CUENTAS DE ORDEN ACREEDORAS','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL);
...
INSERT INTO `maenits` VALUES (1,'C','1090398479','1',3,'INGRID JOHANNA SUTACHAN','1120','CALLE 168','123','123',NULL);
...
CREATE TABLE `maepagos` (
  ...
  PRIMARY KEY (`idpagos`),
  KEY `fk_ciapagos_idx` (`idcompania`),
  KEY `fk_cuentapagos_idx` (`cuenta`),
  KEY `fk_nitpagos_idx` (`idnit`),
  CONSTRAINT `fk_ciapagos` FOREIGN KEY (`idcompania`) REFERENCES `compania` (`idcompania`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `movimi` (
  ...
  KEY `fk_ciamovimi_idx` (`idcompania`),
  ...
  CONSTRAINT `fk_ciamovimi` FOREIGN KEY (`idcompania`) REFERENCES `compania` (`idcompania`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `usuario` (
  ...
  KEY `fk_usuario_idx` (`idusuariodat`),
  CONSTRAINT `fk_usuario` FOREIGN KEY (`idusuariodat`) REFERENCES `datosusuario` (`idusuariodat`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-02-13 11:10:57
