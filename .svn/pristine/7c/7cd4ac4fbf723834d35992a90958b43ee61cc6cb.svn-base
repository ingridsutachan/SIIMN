...
CREATE TABLE `mes` (
  `idmes` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id del mes',
  `nombremes` varchar(10) NOT NULL COMMENT 'nombre del mes',
  PRIMARY KEY (`idmes`),
  UNIQUE KEY `idmes_UNIQUE` (`idmes`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='meses';
