...
CREATE TABLE `cajero` (
  `codigocaje` int(11) NOT NULL,
  `usuariocaje` varchar(10) NOT NULL,
  `nombrecaje` varchar(45) NOT NULL,
  `claverecibos` char(112) NOT NULL,
  PRIMARY KEY (`codigocaje`)
