...
CREATE TABLE `tiponit` (
  `idtiponit` int(2) NOT NULL AUTO_INCREMENT COMMENT 'codigo de tipo nit',
  `nombretipo` varchar(45) NOT NULL COMMENT 'nombre tipo nit',
  PRIMARY KEY (`idtiponit`),
  UNIQUE KEY `idtipo_nit_UNIQUE` (`idtiponit`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='tipo de nit';
...
INSERT INTO `tiponit` VALUES (1,'Nit'),(2,'Cedula'),(3,'Cedula de Extranjeria'),(4,'Tarjeta de Identidad'),(5,'Pasaporte'),(6,'Registro Civil'),(7,'Tarjeta de Identidad');
