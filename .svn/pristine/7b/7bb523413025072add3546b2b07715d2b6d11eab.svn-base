...
CREATE TABLE `maebanta` (
  ...
  `nombrebantal` varchar(45) NOT NULL,
...
INSERT INTO `maebanta` VALUES ('1','BANCO COLOMBIA','T'),('2','BANCO BOGOTA','B'),('3','TARJETA CREDITO ','T'),('4','BANCO COLMENA','B'),('5','BANCO COLPATRIA','B');
