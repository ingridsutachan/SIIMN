...
INSERT INTO `maeconta` VALUES ('1','M','ACTIVO','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('11','M','DISPONIBLE','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1102','A','CUENTA AUXILIAR PRUEBA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('110201','A','CUENTA MAS','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1103','A','CUENTA AUXILIAR PRUEBA 2','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1104','A','CUENTA AUXILIAR PRUEBA 3','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1105','M','CAJA','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('110505','A','CAJA GENERAL','','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('11050501','A','CAJA GENERAL SEDE NORTE','\0','\0','',1,'110505','110505','D','\0',NULL,NULL,NULL,'\0',NULL),('11050502','A','CAJA GENERAL OTRA SEDE','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('11050503','A','CAJA GENERAL SEDE 3','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1106','A','CUENTA AUXILIAR 4 PRUEBA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1107','A','CUENTA AUXILIAR 5 PRUEBA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1108','A','CUENTA PRUEBA 7','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1109','A','CUENTA OTRA PRUEBA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1110','M','BANCOS','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('111005','A','MONEDA NACIONAL ','','','',1,'11050501','110505','D','\0',NULL,NULL,NULL,'\0',NULL),('1112','A','CUENTA AUXILIAR SIGUIENTE PRUEBA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1113','A','CUENTA OTRA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1114','A','OTRA CUENTA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1115','M','REMESAS EN TRANSITO','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1116','A','CUENTA AUXILIAR OTRA PRUEBA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1117','A','CUENTA OTRA PRUEBA DOS','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1118','A','PRUEBA CUENTA OTRA','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1120','A','CUENTA OTRA PR','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1125','A','FONDOS','\0','\0','',1,'110505','110505',NULL,'\0',NULL,NULL,NULL,'\0',NULL),('1140','A','CUENTA VALOR','','','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('12','M','INVERSIONES','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('4','M','PATRIMONIO','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('5','M','GASTOS','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('6','M','COSTOS DE VENTA','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('7','M','COSTOS DE PRODUCION O DE OPERACION','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL),('8','M','CUENTAS DE ORDEN DEUDORAS','\0','\0','\0',NULL,NULL,NULL,NULL,'\0',NULL,NULL,NULL,'\0',NULL);
...
INSERT INTO `movimi` VALUES (4,'1',1,'01','2014','2014-06-18 10:34:09','1',1,1,10,'110505','blabla',NULL,NULL,NULL,100.00,0.00,0.00,0.00,'\0','\0',1,'2014-06-18 10:34:09',NULL,NULL,NULL);
...
CREATE TABLE `parametro` (
  ...
  CONSTRAINT `fk_parmodulo` FOREIGN KEY (`idmoduloppal`) REFERENCES `moduloppal` (`idmoduloppal`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `parametro` VALUES (1,'cueniniing',1,'CUENTA INICIAL DE INGRESOS CONTABILIDAD','1105'),(2,'cuenfining',1,'CUENTA FINAL DE INGRESOS CONTABILIDAD','1105'),(3,'cueninicos',1,'CUENTA INICIAL DE COSTOS CONTABILIDAD','1105'),(4,'cuenfincos',1,'CUENTA FINAL DE COSTOS CONTABILIDAD','1105'),(5,'cuenuti',1,'CUENTA UTILIDAD CONTABILIDAD','1105'),(6,'codcomp',1,'CODIGO COMPROBANTE CONTABILIDAD','1'),(7,'descomp',1,'DETALLE COMPROBANTE CIERRE CONTABILIDAD','OTRAS');
...
CREATE TABLE `saldoscuentas` (
  ...
  `mes` varchar(2) NOT NULL,
  `saldocuenta` decimal(16,2) NOT NULL,
...
INSERT INTO `saldoscuentas` VALUES (1,1,'111005',2014,'1',12564.00);
/*!40000 ALTER TABLE `saldoscuentas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `saldospagos`
--

DROP TABLE IF EXISTS `saldospagos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `saldospagos` (
  `idsaldospagos` int(11) NOT NULL AUTO_INCREMENT,
  `idsucursal` int(11) NOT NULL,
  `idnit` int(11) NOT NULL,
  `cuenta` varchar(10) NOT NULL,
  `mes` varchar(2) NOT NULL,
  ...
  `movimiento` decimal(16,2) NOT NULL,
  PRIMARY KEY (`idsaldospagos`),
  KEY `fk_nitsaldos_idx` (`idnit`),
  KEY `fk_cuentasaldos_idx` (`cuenta`),
  KEY `fk_sucursalsalpagos_idx` (`idsucursal`),
  CONSTRAINT `fk_ciasaldospagos` FOREIGN KEY (`idsucursal`) REFERENCES `sucursal` (`idsucursal`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_cuentasaldos` FOREIGN KEY (`cuenta`) REFERENCES `maeconta` (`cuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_nitsaldos` FOREIGN KEY (`idnit`) REFERENCES `maenits` (`idnit`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `saldospagos`
--

LOCK TABLES `saldospagos` WRITE;
/*!40000 ALTER TABLE `saldospagos` DISABLE KEYS */;
/*!40000 ALTER TABLE `saldospagos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tipodocumento` (
  `idtipodocumento` int(11) NOT NULL,
  `descriptipodoc` varchar(45) NOT NULL,
...
INSERT INTO `tipodocumento` VALUES (1,'FACTURA');
...
-- Dump completed on 2015-03-06 13:16:06
