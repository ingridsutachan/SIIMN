        ...
        public void GenerarAsientoCierreEstado(List<int> cuentasiding, List<int> cuentasidcos, int? idutlidad, int comprob, string detalle, string anio, int sucursal, int usuario)
        {
            ...
            try
            {
                using (siimnEntities bd = new siimnEntities())
                {
                    ...
                    decimal credimesut = 0;
                    decimal debimesuti = 0;
                    ...
                    foreach (var item in saldos.ToList())
                    {
                        ...
                        asiento.valorcredito = item.saldomes>0 ? 0 : 0 ;
                        asiento.valordebito = 0 ;
                        asiento.valorica = 0;
                        credimesut = credimesut + item.credimes;
                        debimesuti = debimesuti + item.debimes;
                        saldomesuti = debimesuti + item.debimes;
                     ...
                     movimi asiecierre = new movimi();
                        ...
                        asiecierre.mes = 12;
                        asiecierre.valorcredito = credimesut;
                        asiecierre.valordebito = debimesuti;
